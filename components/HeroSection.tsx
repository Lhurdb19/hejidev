...
export default function HeroSection({ imageUrl }: HeroSectionProps) {
  ...
  return (
    <section className="relative w-full max-w-8xl mx-auto px-6 md:px-16 py-32 overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 -z-20 bg-gradient-to-br from-purple-50 to-purple-200 dark:from-gray-900 dark:to-gray-800"></div>
      ...
      <div className="max-w-7xl relative z-10 flex flex-col-reverse md:flex-row items-center justify-between mx-auto gap-10 md:gap-16">
        ...
        <div className="flex-1 space-y-6 text-center md:text-left">
          <motion.h1
            ...
            className="text-4xl md:text-6xl max-w-2xl font-bold leading-tight"
          >
        ...
        {imageUrl && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-56 h-56 md:w-72 md:h-72 rounded-full overflow-hidden shadow-2xl ring-4 ring-purple-600/20 dark:ring-purple-400/20"
            >
              <Image
                src={imageUrl}
                alt="HejiDev"
                ...
                priority
              />
              <div className="absolute inset-0 rounded-full bg-gradient-to-br from-purple-400/20 to-purple-600/20 blur-xl animate-pulse"></div>
            </motion.div>
            ...
            <div className="mt-6 flex justify-center gap-1">
              <motion.span
                className="text-2xl md:text-3xl font-semibold text-purple-600 dark:text-purple-400 drop-shadow-lg"
              ...
              {name.map((letter, i) => (
                <motion.span
                  key={i}
                  className="text-3xl md:text-4xl font-extrabold text-purple-600 dark:text-purple-400 drop-shadow-lg"
